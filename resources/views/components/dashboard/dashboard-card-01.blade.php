<div
    ...
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                <button class="text-slate-400 hover:text-slate-500 rounded-full"
                    :class="{ 'bg-slate-100 text-slate-500': open }" aria-haspopup="true" @click.prevent="open = !open"
                    :aria-expanded="open">
        ...
        <h2 class="text-lg font-semibold text-slate-800 mb-2">Uploads</h2>
        <div class="text-xs font-semibold text-slate-400 uppercase mb-1">This Week</div>
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 mr-2">{{ number_format($dataFeed->sumDataSet(1, 1), 0) }}
            </div>
